 ...
 * provided by NVIDIA on NVIDIA? website (collectively, the "Software")
 ...
 * license under NVIDIA? copyrights to 
 * 
 ...
 * necessary to resolve NVIDIA? objections. NVIDIA may reasonably monitor
 ...
 * 
 * (z) any goodwill attached to NVIDIA? trademarks, service marks, or
 ...
 * Software.  In Your sole discretion, You may grant NVIDIA, upon NVIDIA?
 ...
 * EXCEPT WITH RESPECT TO THE MISUSE OF THE OTHER PARTY? INTELLECTUAL
 * PROPERTY OR DISCLOSURE OF THE OTHER PARTY? CONFIDENTIAL INFORMATION IN
 ...
 * JURISDICTION.  NOTWITHSTANDING THE FOREGOING, NVIDIA? AGGREGATE
 ...
 * This Agreement and Licensee? rights and obligations herein, may not be
 * assigned, subcontracted, delegated, or otherwise transferred by Licensee
 * without NVIDIA? prior written consent, and any attempted assignment,
 ...
 * Licensee? relationship to NVIDIA is that of an independent contractor,
