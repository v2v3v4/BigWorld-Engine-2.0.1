...
xcopy /Y %SRC_DIR_DEBUG%\dist\lib\nspr4.lib						%DEST_DIR%\lib_debug_2008\
xcopy /Y %SRC_DIR_DEBUG%\dist\lib\plc4.lib							%DEST_DIR%\lib_debug_2008\
xcopy /Y %SRC_DIR_DEBUG%\dist\lib\profdirserviceprovider_s.lib		%DEST_DIR%\lib_debug_2008\
xcopy /Y %SRC_DIR_DEBUG%\dist\lib\xpcom.lib						%DEST_DIR%\lib_debug_2008\
xcopy /Y %SRC_DIR_DEBUG%\dist\lib\xul.lib							%DEST_DIR%\lib_debug_2008\

@echo ========== copying debug runtime files ==========
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\chrome\*.*						%DEST_DIR%\runtime_debug_2008\chrome\ /s
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\components\*.*					%DEST_DIR%\runtime_debug_2008\components\ /s
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\greprefs\*.*						%DEST_DIR%\runtime_debug_2008\greprefs\ /s
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\plugins\*.*						%DEST_DIR%\runtime_debug_2008\plugins\ /s
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\res\*.*							%DEST_DIR%\runtime_debug_2008\res\ /s
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\*.dll							%DEST_DIR%\runtime_debug_2008\
xcopy /Y %SRC_DIR_DEBUG%\dist\bin\windbgdlg.exe					%DEST_DIR%\runtime_debug_2008\

@echo ========== copying release (opt) libraries ==========
xcopy /Y %SRC_DIR_OPT%\dist\lib\nspr4.lib							%DEST_DIR%\lib_release_2008\
xcopy /Y %SRC_DIR_OPT%\dist\lib\plc4.lib							%DEST_DIR%\lib_release_2008\
xcopy /Y %SRC_DIR_OPT%\dist\lib\profdirserviceprovider_s.lib		%DEST_DIR%\lib_release_2008\
xcopy /Y %SRC_DIR_OPT%\dist\lib\xpcom.lib							%DEST_DIR%\lib_release_2008\
xcopy /Y %SRC_DIR_OPT%\dist\lib\xul.lib							%DEST_DIR%\lib_release_2008\

@echo ========== copying release (opt) runtime files ==========
xcopy /Y %SRC_DIR_OPT%\dist\bin\chrome\*.*							%DEST_DIR%\runtime_release_2008\chrome\ /s
xcopy /Y %SRC_DIR_OPT%\dist\bin\components\*.*						%DEST_DIR%\runtime_release_2008\components\ /s
xcopy /Y %SRC_DIR_OPT%\dist\bin\greprefs\*.*						%DEST_DIR%\runtime_release_2008\greprefs\ /s
xcopy /Y %SRC_DIR_OPT%\dist\bin\plugins\*.*						%DEST_DIR%\runtime_release_2008\plugins\ /s
xcopy /Y %SRC_DIR_OPT%\dist\bin\res\*.*							%DEST_DIR%\runtime_release_2008\res\ /s
xcopy /Y %SRC_DIR_OPT%\dist\bin\*.dll								%DEST_DIR%\runtime_release_2008\
