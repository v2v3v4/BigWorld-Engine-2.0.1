...
//@line 41 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 238 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 254 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 268 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
      aLeafName = appName;
//@line 273 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
...
//@line 344 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
...
//@line 351 "/cygdrive/c/mozilla/xulrunner/setup/nsXULAppInstall.js"
  }
};
