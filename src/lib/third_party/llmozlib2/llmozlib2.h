...
#define INVALID_MOZILLA_WINDOW (-1)
...
class LLMozLib
{
	public:
		...
		bool allowCursorInteraction( bool allow );
		...
		void cleanMemory( int browserWindowIdIn);
		...
		bool mouseDown( int browserWindowIdIn, int xPosIn, int yPosIn, int exactWidth, int exactHeight );			// send a mouse down event to a browser window at given XY in browser space
		bool mouseUp( int browserWindowIdIn, int xPosIn, int yPosIn, int exactWidth, int exactHeight );				// send a mouse up event to a browser window at given XY in browser space
		bool mouseMove( int browserWindowIdIn, int xPosIn, int yPosIn, int exactWidth, int exactHeight );			// send a mouse move event to a browser window at given XY in browser space
		bool mouseLeftDoubleClick( int browserWindowIdIn, int xPosIn, int yPosIn, int exactWidth, int exactHeight );	// send a mouse left button double click to a browser window at given XY in browser space
		bool keyPress( int browserWindowIdIn, int keyCodeIn );						// send a key press event to a browser window
		bool unicodeInput ( int browserWindowIdIn, unsigned long uni_char, unsigned long codePage );		// send a unicode keypress event to a browser window
	...
	private:
		...
		const unsigned int mMaxBrowserWindows;
		...
		typedef std::list<LLEmbeddedBrowserWindow*> BrowserWindowList;
		BrowserWindowMap mBrowserWindowMap;
		BrowserWindowList mBrowserWindowList;
};
