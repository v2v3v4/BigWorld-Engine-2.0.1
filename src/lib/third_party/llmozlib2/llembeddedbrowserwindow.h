	...
	public nsIToolkitObserver
{
	public:
		...
		void mouseDown( PRInt16 xPosIn, PRInt16 yPosIn, PRInt16 exactWidth, PRInt16 exactHeight );
		void mouseUp( PRInt16 xPosIn, PRInt16 yPosIn, PRInt16 exactWidth, PRInt16 exactHeight );
		void mouseMove( PRInt16 xPosIn, PRInt16 yPosIn, PRInt16 exactWidth, PRInt16 exactHeight );
		void mouseLeftDoubleClick( PRInt16 xPosIn, PRInt16 yPosIn, PRInt16 exactWidth, PRInt16 exactHeight );
		void keyPress( PRInt16 keyCode );
		void unicodeInput( PRUint32 uni_char, PRUint32 codePage );
	...
	private:
		PRBool sendMozillaMouseEvent( PRInt16 eventIn, PRInt16 xPosIn, PRInt16 yPosIn, PRUint32 clickCountIn, PRInt16 exactWidth, PRInt16 exactHeight );
		PRBool sendMozillaKeyboardEvent( PRUint32 keyIn, PRUint32 ns_vk_code, PRUint32 codePage );
		PRBool renderCaret();
