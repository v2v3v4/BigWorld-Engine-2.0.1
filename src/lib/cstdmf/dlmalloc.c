...
// BigWorld conditional compile
#ifdef EDITOR_ENABLED

///////////////////////////////////////////////////////////////////////////////
//  BigWorld-specific Code
///////////////////////////////////////////////////////////////////////////////


// BigWorld definition of THREADLOCAL
#ifdef WIN32
...
// Static variable for temporal run-time override
// Also useful for debugging purposes, whenever one might want to use the
// standard malloc/realloc/free instead of the dl* versions.
static THREADLOCAL int g_use_custom_allocator = 1;


// Temporal run-time override
int dlenabled( int enabled )
{
	int old_state = g_use_custom_allocator;
	g_use_custom_allocator = enabled;
	return old_state;
}


// BigWorld definition of strdup
char * dlstrdup( const char * str )
{
	size_t len = strlen( str ) + 1;
	char * new_str = (char *)dlmalloc( len );
	memcpy( new_str, str, len );
	return new_str;
}


// BigWorld definition of wcsdup
wchar_t * dlwcsdup( const wchar_t * str )
{
	size_t len = wcslen( str ) + 1;
	size_t size = len * sizeof( wchar_t );
	wchar_t * new_str = (wchar_t *)dlmalloc( size );
...
// End BigWorld conditional compile
