...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        # BigWorld: modified to locate the redist version of OpenSSL
        openssl_redist_dir = os.environ.get("MF_ROOT") + "/src/lib/third_party"
        openssl_redist_inc = openssl_redist_dir + "/openssl/include"
        search_for_ssl_incs_in = [ openssl_redist_inc, ]
        ...
        #                              '/usr/contrib/ssl/lib/'
        #                             ] )
        # BigWorld: Use the ssl libs we ship		
        ssl_lib = os.environ.get("MF_ROOT") + "/lib/Hybrid"
        if sys.maxint == 9223372036854775807L:
            ssl_lib = ssl_lib + "64"
        ssl_libs = [ ssl_lib ]
